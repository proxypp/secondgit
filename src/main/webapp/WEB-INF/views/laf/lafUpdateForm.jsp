...
<body>
 ...
 <form action="lafUpdatess.do" method="post">
        <label for="number"><h1 style="color: blue">수정할 번호</h1>
         	<div><h3>${no}</h3> </div>
        </label><br>
        <label for="name"><h1 style="color: blue">모델 수정</h1>
         	<input type="text" name="lmodel" id="lmodel" placeholder="모델">
        </label><br>
        <label for="address"><h1 style="color: blue">이름 수정</h1>
         	<input type="text" name="lname" id="lname" placeholder="이름">
        </label><br>
        <label for="tel"><h1 style="color: blue">보관 위치 수정</h1>
         	<input type="text" name="location" id="location" placeholder="위치">
        </label>
        <label for="tel"><h1 style="color: blue">보관소 번호</h1>
			<input type="text" name="ltel" id="ltel" placeholder="전화번호">
        </label>
