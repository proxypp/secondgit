...
$(document).ready(function(){
		$('#btn1').click(function(){
			if (confirm("수정하시겠습니까?")) {
			document.form1.action = "lafUpdateForm.do";
  ...
  <div id="main">
    ...
    <div class="card" style="height: 700px;">
      ...
      <form id="form1" name="form1" method="post">
        ...
        <input type="button" value="수정" id="btn1" name="btn1">&nbsp;&nbsp;&nbsp;
        </c:if>
        </form><br>
		<form action="lafdelete.do" method="post">
		<c:if test="${author eq 'ADMIN' }">
		<input type="hidden" id="no" name="no" value="${laf.lnum }">
